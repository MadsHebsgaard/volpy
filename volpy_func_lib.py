...
def plot_returns(df, sgy_common, sgy_names, factors = [], figsize=(30, 10), lw = 0.5, fig_name = None, prefix = ""):
    ...
    for sgy_name in sgy_names:
        ...
        formatted = rf"{prefix}{sgy_name}".replace("_", " ").title().replace("Otm", "OTM").replace("Atm", "ATM").replace("Full Stacked Strangle", "Multi Strangle 5% 15%")
